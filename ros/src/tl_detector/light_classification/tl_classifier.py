...
class TLClassifier(object):
    ...
    def get_classification(self, image):
        ...
        with self.detection_graph.as_default():
            ...
            outimage = image
            imagename = '/home/sachit/Desktop/read images/image' + str(self.counter).zfill(5) + '.jpg'
            self.counter+=1
            scipy.misc.imsave(imagename, outimage)
            ...
            try:
                #self.image_pub.publish(self.bridge.cv2_to_imgmsg(outimage, "bgr8"))
